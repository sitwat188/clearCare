...
export declare class ComplianceService {
    ...
    getComplianceRecords(requestingUserId: string, requestingUserRole: string, filters?: {
        instructionId?: string;
        patientId?: string;
        type?: string;
    }): Promise<({
    ...
    getComplianceMetrics(requestingUserId: string, requestingUserRole: string, filters?: {
        patientId?: string;
        instructionId?: string;
    }): Promise<{
        patientId: string;
