...
<head>
  ...
  <title>Your ClearCare+ account was restored</title>
</head>
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width: 480px; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.07); overflow: hidden;">
          ...
          <tr>
            <td style="padding: 28px 24px;">
              <h1 style="margin: 0 0 16px 0; font-size: 20px; font-weight: 600; color: #1e293b;">Your account was restored</h1>
              <p style="margin: 0 0 20px 0; font-size: 15px; line-height: 1.6; color: #475569;">Hi ${safeName}, an administrator has restored your ClearCare+ account. You can log in again with your existing password.</p>
              <p style="margin: 0 0 20px 0; font-size: 15px; line-height: 1.6; color: #475569;">If you do not remember your password, use the &quot;Forgot password&quot; link on the sign-in page.</p>
              ...
              <p style="margin: 24px 0 0 0; font-size: 13px; color: #94a3b8;">If you did not expect this, contact your administrator.</p>
            </td>
          </tr>
          <tr>
